...
namespace gazebo
{
                               ...
                               gazebo::math::Pose target_to_reference )
    {
      ...
      /* XEN: took this out because it was throwing off torques for xen_quad. 
        The entirety of applyBodyWrench NEEDS to be revisited and have its documentation
        updated to reflect how it should ACTUALLY BE USED, because I currently
        HAVE NO IDEA. */
